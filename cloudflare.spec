...
Requires: cloudflare-man = %{version}-%{release}
...
%package man
Summary: man components for the cloudflare package.
Group: Default

%description man
man components for the cloudflare package.
...
cp %{_builddir}/cloudflare-2.8.15/LICENSE %{buildroot}/usr/share/package-licenses/cloudflare/1857fba4ea5c0240235ad8374c2a15727733798e
